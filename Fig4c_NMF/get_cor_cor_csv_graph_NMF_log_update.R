...
#filename=args[1]
#outname=args[2]
#filename="Buttock6NMFData"
#outname="S4A_Buttocks_NMF"
#filename="Face6NMFData"
#outname="S4C_Face_NMF"
filename="Forearm6NMFData"
outname="S4B_Forarm_NMF"
#rm(args)
...
library(corrplot)
res <- cor(as.matrix(xx), method="spearman")
round(res, 2)

tiff(filename = paste0(outname,".Cor.tiff"), width = 3860, height = 3860, res=300)
